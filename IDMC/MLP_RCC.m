function accuracy=MLP_RCC(ri, nwl,nbl,fc1_w, fc1_b, fc2_w, fc2_b, test_input, test_label)
tic
rwl=ri;
rbl=ri;
rlrs=50e3;
...
[fc1_iAp, fc1_iAn, fc1_iBp, fc1_iBn]=compensationC(gwl,gbl,nwl,nbl,fc1_Gp, fc1_Gn, Vread);
[fc2_iAp, fc2_iAn, fc2_iBp, fc2_iBn]=compensationC(gwl,gbl,nwl,nbl,fc2_Gp, fc2_Gn, Vread);
parfor i = 1:10000
    input = test_input(i,:);
